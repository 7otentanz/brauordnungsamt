...
Außerdem erstellt das **Brauordnungsamt** ein Brautagebuch für dich, dass du jederzeit auf eine potenzielle Kontrolle des Zolls vorbereitet bist.  
Apropos Zoll: Bei Bedarf erstellt dir das **Brauordnungsamt** aus einem deiner Brauprotokolle ein vollständiges Formular 2075 zur Biersteueranmeldung in wenigen Klicks!  
...
Die Installation des **Brauordnungsamt** auf deinem Raspberry Pi ist auch ohne Programmierkenntnisse einfach möglich - an dieser Stelle führe ich dich kurz und knackig durch den Installationsprozess, sodass du so schnell wie möglich wieder an den Braukessel kannst.
...
§ Disclaimer an dieser Stelle: *Strom von der Steckdose kann tödlich sein! Elektroinstallationen dürfen nur von Elektrofachkräften durchgeführt werden!*
...
Wenn du jetzt mit einem Browser auf deinem Computer <a href="http://horst.local:8000/">horst.local:8000</a> besuchst, siehst du die Landing Page von **Brauordnungsamt**!  
